    ...
    <main className={styles.main}>
      ...
      <div className={styles.flexTo}>
        <div className={styles.flexVenstreTo}>
          ...
          <p>
            Velkommen til BigFives personlighetstest. Den ultimate løsningen for
            bedrifter som ønsker å forme en mer effektiv og harmonisk
            arbeidsstyrke.
          </p>
        </div>
        <div className={styles.flexMidtTo}>
          ...
          <p>
            ...
            viktige aspekter og hjelper deg med å identifisere de beste
            kandidatene for din bedriftskultur.
          </p>
        </div>
        <div className={styles.flexHøyreTo}>
          ...
          <p>
            Registrer deg nå for å få tilgang til vårt kraftfulle verktøy og ta
            det første skrittet mot å skape en sterkere og mer produktiv
            arbeidsstyrke!
          </p>
        </div>
      </div>
      <div className={styles.text}>
        <h2>Velg Smart!</h2>
        <p>
          BigFive tilbyr bedrifter en effektiv løsning for å forbedre
          rekrutteringsprosessen. Ved å bruke vår plattform kan bedrifter få
          innsikt i kandidatenes personlighetsegenskaper, noe som hjelper dem
          med å velge de rette kandidatene som passer godt inn i deres
          arbeidsmiljø og bedriftskultur.
        </p>
        <p>
          Vår personlighetstest gir bedrifter verktøyene de trenger for å ta
          velinformerte beslutninger og bygge en sterkere og mer produktiv
          arbeidsstyrke.
        </p>
      </div>
    </main>
