    ...
    <main className={styles.main}>
      <div className={styles.flexEn}>
        ...
        <div className={styles.flexHøyreEn}>
          ...
          <p>
            Forstå dine kollegaer og eventuelle ansatte bedre ved hjelp av denne
      ...
      <div className={styles.flexTo}>
        ...
        <div className={styles.flexHøyreTo}>
          <h1>Test deg selv</h1>
          <p>
            Her har du mulighet til å ta testen og teste deg selv for å se om du
            er kompatilbel med jobben din
          </p>
          <p>test deg selv her:</p>
          <ul>
            <li>
              <Link href="https://bigfive-test.com">Personlighetstest</Link>
            </li>
          </ul>
        </div>
      </div>
